...
**Doğrulama durumu:** 70 kategori görseli ve 19 yeni sahnenin üretimi, paketlenmesi, görsel eşleşme incelemesi ve dosya bütünlüğü kontrolleri tamamlandı. Önceki dört sahneyle birlikte uygulamadaki 23 sahnenin kaynak dosyaları da doğrulandı. GitHub Actions derlemesi, 48 JVM ve 26 Android testi geçti; lint hatası yok. Normal ve büyük yazı ekranları incelendi. Fiziksel cihaz ve animasyon hissi sınırları test raporunda açıklanır. Sürümün kabul adımları ve sonuç alanları [test planındadır](13-ASCEND-6-TEST-PLANI.md). Önceki sürümün başarılı testleri bu sürüme ait sonuç olarak kullanılmaz.
...
V6'nın kaynakta ele aldığı alanlar: kategori erişimi ve geçişi, bildirim planı, seçili konuların görünürlüğü, marka/nav/Yolculuk, Pro demosu, paylaşım erişimi ve 23 sahnenin filtreli seçimi. Tam kapsamın 89 yeni görseli, dosya envanterleri ve son boyut ölçümleri doğrulandı. Son [Actions koşusunda](https://github.com/yalnizfahrettin06-tech/Ascend/actions/runs/34229375936) APK derlendi; 48 birim testi ve 26 Android testi geçti. Ekran kanıtları incelendi, APK imzası doğrulandı. Lint sonucu 0 hata ve 141 uyarıdır. Fiziksel Samsung cihazı, üreticiye bağlı bildirim gecikmeleri ve hedef sosyal uygulamalardaki paylaşım ayrıca denenmelidir; ayrıntılar [doğrulama raporundadır](13-ASCEND-6-TEST-PLANI.md).
...
Test cihazındaki ekran görüntüsü görsel kanıttır; APK imza doğrulaması dosyanın imza bütünlüğünü gösterir; test raporu davranış kanıtıdır. Bunların hiçbiri tek başına her telefon, her bildirim ayarı ve her paylaşım uygulaması için eksiksiz doğrulama yerine geçmez. Son sürümün kanıtları [kabul planındaki sonuç alanında](13-ASCEND-6-TEST-PLANI.md) ve [ekran galerisinde](14-ASCEND-6-EKRANLAR.md) yer alır.
